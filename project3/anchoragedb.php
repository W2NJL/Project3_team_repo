...
<body>
    ...
    <div class="page-heading">
        <div class="container">
            <div class="heading-content">
                ...
                <h1>Anchorage <em>Climate Data</em></h1>
            </div>
        </div>
    </div>
    <div class="services">
    ...
    die("ERROR: Could not connect. " . mysqli_connect_error());
                        ...
                        if(isset($_POST["Day"])){
                      $sql = "SELECT * FROM `anchorage` WHERE Year ='$year' AND Month ='$month' AND Day ='$day'";
                    ...
                    if(isSet($_POST["Record"])){
                      if($record=="max"){
                      $sql = "SELECT * FROM `anchorage` ORDER BY Max DESC LIMIT 10";
                    ...
                    if($record=="min"){
                      $sql = "SELECT * FROM `anchorage` ORDER BY Min ASC LIMIT 10";
                    ...
                    if($record=="snow"){
                      $sql = "SELECT * FROM `anchorage` ORDER BY Snowfall DESC LIMIT 10";
                    ...
                    if($record=="rain"){
                      $sql = "SELECT * FROM `anchorage` ORDER BY Precip DESC LIMIT 10";
                      ...
                      $sql = "SELECT * FROM `anchorage` WHERE Year ='$year' AND Month ='$month'";
