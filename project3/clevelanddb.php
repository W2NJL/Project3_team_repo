...
<body>
    ...
    <div class="page-heading">
        <div class="container">
            <div class="heading-content">
                ...
                <h1>Cleveland <em>Climate Data</em></h1>
            </div>
        </div>
    </div>
    <div class="services">
    ...
    die("ERROR: Could not connect. " . mysqli_connect_error());
                        ...
                        if(isset($_POST["Day"])){
                      $sql = "SELECT * FROM `cleveland` WHERE Year ='$year' AND Month ='$month' AND Day ='$day'";
                    ...
                    if(isSet($_POST["Record"])){
                      if($record=="max"){
                      $sql = "SELECT * FROM `cleveland` ORDER BY Max DESC LIMIT 10";
                    ...
                    if($record=="min"){
                      $sql = "SELECT * FROM `cleveland` ORDER BY Min ASC LIMIT 10";
                    ...
                    if($record=="snow"){
                      $sql = "SELECT * FROM `cleveland` ORDER BY Snowfall DESC LIMIT 10";
                    ...
                    if($record=="rain"){
                      $sql = "SELECT * FROM `cleveland` ORDER BY Precip DESC LIMIT 10";
                      ...
                      $sql = "SELECT * FROM `cleveland` WHERE Year ='$year' AND Month ='$month'";
